...
const Config = {
  ...
  random: [
    ...
    [
      null,
      { color: false, piece: 3 as PieceType as PieceType },
      null,
      { color: true, piece: 4 as PieceType as PieceType },
      null,
      { color: false, piece: 0 as PieceType as PieceType },
      null,
      { color: true, piece: 5 as PieceType as PieceType },
    ],
    [
      { color: true, piece: 1 as PieceType as PieceType },
      null,
      { color: false, piece: 2 as PieceType as PieceType },
      null,
      { color: true, piece: 0 as PieceType as PieceType },
      null,
      { color: false, piece: 3 as PieceType as PieceType },
      null,
    ],
